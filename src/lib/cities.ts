...
export const CITIES: City[] = [
  // 27 capitais — coords reais (geograficamente corretos)
  { name: "São Paulo",       state: "SP", lng: -46.633, lat: -23.55, tier: "capital" },
  { name: "Rio de Janeiro",  state: "RJ", lng: -43.196, lat: -22.91, tier: "capital" },
  { name: "Brasília",        state: "DF", lng: -47.929, lat: -15.78, tier: "capital" },
  { name: "Salvador",        state: "BA", lng: -38.510, lat: -12.97, tier: "capital" },
  { name: "Fortaleza",       state: "CE", lng: -38.543, lat: -3.71,  tier: "capital" },
  ...
  { name: "Recife",          state: "PE", lng: -34.881, lat: -8.05,  tier: "capital" },
  { name: "Goiânia",         state: "GO", lng: -49.253, lat: -16.68, tier: "capital" },
  { name: "Belém",           state: "PA", lng: -48.502, lat: -1.46,  tier: "capital" },
  { name: "Porto Alegre",    state: "RS", lng: -51.230, lat: -30.03, tier: "capital" },
  { name: "São Luís",        state: "MA", lng: -44.300, lat: -2.53,  tier: "capital" },
  { name: "Maceió",          state: "AL", lng: -35.738, lat: -9.65,  tier: "capital" },
  { name: "Campo Grande",    state: "MS", lng: -54.620, lat: -20.45, tier: "capital" },
  { name: "Natal",           state: "RN", lng: -35.211, lat: -5.79,  tier: "capital" },
  { name: "Teresina",        state: "PI", lng: -42.800, lat: -5.09,  tier: "capital" },
  { name: "João Pessoa",     state: "PB", lng: -34.860, lat: -7.12,  tier: "capital" },
  { name: "Cuiabá",          state: "MT", lng: -56.097, lat: -15.60, tier: "capital" },
  { name: "Aracaju",         state: "SE", lng: -37.072, lat: -10.91, tier: "capital" },
  { name: "Florianópolis",   state: "SC", lng: -48.548, lat: -27.59, tier: "capital" },
  { name: "Vitória",         state: "ES", lng: -40.338, lat: -20.32, tier: "capital" },
  { name: "Macapá",          state: "AP", lng: -51.066, lat: 0.04,   tier: "capital" },
  ...
  { name: "Santos",              state: "SP", lng: -46.333, lat: -23.96, tier: "polo" },
